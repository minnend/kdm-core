 ...
 */
public class VerticalLabel extends JPanel implements PropertyChangeListener {
	String fLabel;
	 ...
	 * @see #verifyRotation
	 */
 	public VerticalLabel(String label, int rotateHint) {
      setOpaque(false);
		fLabel = label;
    ...
    public void propertyChange(PropertyChangeEvent e) {
		...
		if("font".equals(prop)) recalcDimensions();
	}
	...
	void recalcDimensions() {
		...
		int hOld = fHeight;
		calcDimensions();
		if (wOld != fWidth || hOld != fHeight) invalidate();
	}
