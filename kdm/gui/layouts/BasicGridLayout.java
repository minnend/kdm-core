package kdm.gui.layouts;

// originally from: package com.jhlabs.awt;
//thanks to Jerry Huxtable for sharing his Java code!
...
public class BasicGridLayout extends ConstraintLayout {
	...
	public BasicGridLayout(int rows, int cols, int hGap, int vGap, int hMargin, int vMargin) {
      // modified from Jerry's code which didn't use this.rows and this.cols
